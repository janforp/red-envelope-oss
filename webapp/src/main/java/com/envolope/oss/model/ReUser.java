...
/**
 * Created by com.envolope.oss.MybatisCodeGenerate on 2016-11-29
 */
public class ReUser implements java.io.Serializable {
     ...
     * full constructor
     */
    public ReUser(String reId, String nickname, String realName, String portrait, String userKey, String userSecret, String mobile, String password, Integer gender, String birthday, String profession, String hobby, String address, BigDecimal userMoney, Integer userScore, Long signTime, Integer signCount, Integer bindType, Integer userStatus, Integer userType, String invitationCode, Integer appId, Long createTime, Long updateTime) {
        this.reId = reId;
