...
public class ReBanner implements java.io.Serializable {
     ...
     * full constructor
     */
    public ReBanner(String bannerTitle, String bannerImg, Integer bannerStatus, String bannerUrl, Integer bannerOrder, String limitVersion, String maxVersion, String limitChannelName, String limitPackageName, Integer isShow) {
