...
public class JuheMessage {
    ...
    // 可以传参数的发送短信
    public static String sendMsg(String money, String phone, String msgTplID) throws UnsupportedEncodingException {

        String url = "http://v.juhe.cn/sms/send"; // 请求接口地址
        String result = null;

        String tplVar = "#shop#="+money;
    ...
    // 可以传参数的发送短信
    public static String sendWithdrawMsg(String way, String money, String phone, String msgTplID) throws UnsupportedEncodingException {

        String url = "http://v.juhe.cn/sms/send";//请求接口地址
        String tplVar = "#way#="+way+"&#money#="+money;
        tplVar = URLEncoder.encode(tplVar,DEF_CHATSET);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        String msgBackStr = JuheMessage.sendMsg(" 朱晨剑正在测试 ","13456759092", ValueConsts.MSG_TPL_PHONE_RECHARGE);
