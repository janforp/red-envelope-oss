...
import com.envolope.oss.service.DiscoverBannerService;
 ...
 */
@Controller
@RequestMapping(value = "/page/console/auth/discoverBanner", produces = RequestConsts.CONTENT_TYPE_HTML, method = {RequestMethod.GET, RequestMethod.POST})
public class DiscoverBannerController {

    @Autowired
    private BannerService bannerService;
    @Autowired
    private DiscoverBannerService discoverBannerService;
    @Autowired
    ...
    public String gotoAdList(HttpServletRequest request,
        ...
        PageDto pageDto = discoverBannerService.selectByPage(pageNo, SizeConsts.PAGE_SIZE_DEFAULT);
        ...
        return "console/deploy/discover_banner-list";
    }
    ...
    public String edit(HttpServletRequest request,
        ...
        ReDiscoverBanner banner = discoverBannerService.getBannerById(id);
        if (banner != null) {
    ...
    @ResponseBody
    public String saveBanner(HttpServletRequest request, ReDiscoverBanner banner) throws Exception {
        return discoverBannerService.save(request, banner);
    }
    ...
    public String remove(HttpServletRequest request,
        ...
        if (discoverBannerService.delete(adIds)) {
