...
function deleteSort() {
    ...
    $.ajax({
        url     :   "/c/page/console/auth/sort/deleteSort",
        type    :   "POST",
        dataType:   "JSON",
...
function updateSort() {
    ...
    window.open("/c/page/console/auth/sort/updateSortPage?sortId="+sortId)
}
/**
 * 添加
 */
function addSort() {
    ...
    window.location.href = ("/c/page/console/auth/sort/addSort")
}
