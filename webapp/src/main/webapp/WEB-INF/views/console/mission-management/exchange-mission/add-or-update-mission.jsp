...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    <tiles:putAttribute name="title" value="兑换码任务"/>
    ...
    <tiles:putAttribute name="scriptArea">
        ...
        <script src="/client/js/page/exchange-mission-detail.js" type="text/javascript"></script>
        <script>
            var add = '${add}';
            var update = '${update}';
            var detail = '${detail}';
            ...
            <div class="collapse navbar-collapse">
                <span>
                    <div  class="form-group col-xs-6">
                        ...
                        <img class='img-upload' src='${mission.missionIcon}' mode='button-upload-pic'
                             ...
                             obj='1' value='${mission.missionIcon}' id="missionIcon" name="missionIcon" >
                    </div>
                </span>
            </div>
            <br>
