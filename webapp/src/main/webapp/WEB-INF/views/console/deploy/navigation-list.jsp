...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    ...
    <tiles:putAttribute name="scriptArea">
        <script src="/client/js/page/navigation.js" type="text/javascript"></script>
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        <button class="btn btn-default btn-sm navbar-btn"
                                data-toggle="modal"
                                data-target="#modal-add-navigation"
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-edit-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/navigation/edit"
                                role="button">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-delete-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/navigation/remove"
                                role="button">
            ...
            <table class="table table-striped table-hover table-bordered table-row-check">
                <thead>
                    <tr>
                        ...
                        <th class="w50"><spring:message code="oss.navigation.order"/></th>
                        <th class="w100"><spring:message code="oss.navigation.title"/></th>
                        <th class="w50"><spring:message code="oss.navigation.img"/></th>
                        <th class="w100"><spring:message code="oss.navigation.url"/></th>
                        <th class="w100"><spring:message code="oss.navigation.status"/></th>
                        <th class="w100">最低显示版本</th>
                        <th class="w100">最高显示版本</th>
                        <th class="w100">显示的渠道</th>
                        <th class="w100">显示的包名</th>
                        <th class="w100">审核是否显示</th>
                    </tr>
                </thead>
                <tbody>
                <c:forEach items="${pg.list}" var="v">
                    <tr data-id="${v.navigationId}">
                        <td class="td-vm">
                            <label class="id_checkbox img_checkbox_label in-td-line">
                                <i class="icon_checkbox"></i>
                                <input type="checkbox" class="img_checkbox row-checkbox" value="${v.navigationId}">
                            </label>
                        </td>
                        <td class="td-vm">${v.navigationOrder}</td>
                        <td class="td-vm">${v.navigationTitle}</td>
                        <td class="td-vm"><img src="${v.navigationImg}"></td>
                        <td class="td-vm">${v.navigationUrl}</td>
                        <td class="td-vm">
                            <c:if test="${v.navigationStatus == '0'}">IOS开启</c:if>
                            <c:if test="${v.navigationStatus == '1'}">Andriod开启</c:if>
                            <c:if test="${v.navigationStatus == '2'}">全部开启</c:if>
                            <c:if test="${v.navigationStatus == '3'}">全部关闭</c:if>
                        </td>
                        <td class="td-vm">${v.limitVersion}</td>
                        <td class="td-vm">${v.maxVersion}</td>
                        <td class="td-vm">
                            <c:choose>
    ...
    <tiles:putAttribute name="modalArea">
        ...
        <!-- 添加 begin -->
        <div id="modal-add-navigation" aria-labelledby="modal-add-navigation-title" class="modal fade" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><spring:message code="oss.title.navigation.add"/></h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="add_is_show" id="add_is_show-label">
                                    审核是否显示
                                </label>
                                <select id="add_is_show" name="add_is_show"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success add_submit_btn" id="add_navigation">
        ...
        <!-- 修改 start -->
        <div id="modal-edit-navigation" aria-labelledby="modal-edit-navigation-title" class="modal fade" tabindex="-1"
             role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><spring:message code="oss.title.navigation.edit"/></h4>
                    </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="edit_url" id="edit_url-label">
                                    <spring:message code="oss.navigation.url"/>
                                </label>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="edit_is_show" id="edit_is_show-label">
                                    审核是否显示
                                </label>
                                <select id="edit_is_show" name="edit_is_show"
                                        class="selectpicker show-tick form-control" data-live-search="false">
                                    <option value="0">不显示</option>
                                    <option value="1">显示</option>
                                </select>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default auto-focus-btn" data-dismiss="modal">
                            <spring:message code="btn.cancel"/></button>
                        <button type="button" class="btn btn-success add_submit_btn" id="edit_navigation">
                            <spring:message code="btn.save"/></button>
                    </div>
                </div>
            </div>
