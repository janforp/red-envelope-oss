...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    ...
    <tiles:putAttribute name="scriptArea">
        <script src="/client/js/page/discoverBanner.js" type="text/javascript"></script>
    ...
    <tiles:putAttribute name="mainArea">
        ...
        <div class="main-bd">
            ...
            <nav class="navbar navbar-default sub-title-bar" role="banner">
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-edit-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/discoverBanner/edit"
                                role="button">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-delete-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/discoverBanner/remove"
                                role="button">
            ...
            <table class="table table-striped table-hover table-bordered table-row-check">
                ...
                <tr>
                    ...
                    <th class="w50"><spring:message code="oss.banner.order"/></th>
                    <th class="w100"><spring:message code="oss.banner.title"/></th>
                    <th class="w50"><spring:message code="oss.banner.img"/></th>
                    <th class="w100"><spring:message code="oss.banner.url"/></th>
                    <th class="w100"><spring:message code="oss.banner.status"/></th>
                ...
                <c:forEach items="${pg.list}" var="v">
                    <tr data-id="${v.bannerId}">
                        <td class="td-vm">
                            <label class="id_checkbox img_checkbox_label in-td-line">
                                <i class="icon_checkbox"></i>
                                <input type="checkbox" class="img_checkbox row-checkbox" value="${v.bannerId}">
                            </label>
                        </td>
                        <td class="td-vm">${v.bannerOrder}</td>
                        <td class="td-vm">${v.bannerTitle}</td>
                        <td class="td-vm"><img src="${v.bannerImg}"></td>
                        <td class="td-vm">${v.bannerUrl}</td>
                        <td class="td-vm">
                            <c:if test="${v.bannerStatus == '0'}">IOS开启</c:if>
                            <c:if test="${v.bannerStatus == '1'}">Andriod开启</c:if>
                            <c:if test="${v.bannerStatus == '2'}">全部开启</c:if>
                            <c:if test="${v.bannerStatus == '3'}">全部关闭</c:if>
                        </td>
    ...
    <tiles:putAttribute name="modalArea">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><spring:message code="oss.title.banner.add"/></h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="add_url" id="add_url-label">
                                    <spring:message code="oss.banner.url"/>
                                </label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success add_submit_btn" id="add_banner">
        ...
        <!-- 修改 start -->
        <div id="modal-edit-banner" aria-labelledby="modal-edit-banner-title" class="modal fade" tabindex="-1"
             role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><spring:message code="oss.title.banner.edit"/></h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default auto-focus-btn" data-dismiss="modal">
                            <spring:message code="btn.cancel"/></button>
                        <button type="button" class="btn btn-success add_submit_btn" id="edit_banner">
                            <spring:message code="btn.save"/></button>
                    </div>
                </div>
            </div>
