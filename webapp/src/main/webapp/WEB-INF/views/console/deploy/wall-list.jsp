...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    ...
    <tiles:putAttribute name="scriptArea">
        <script src="/client/js/page/entrance/wall-list.js" type="text/javascript"></script>
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-edit-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/integral/edit"
                                role="button">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-delete-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/integral/remove"
                                role="button">
                    ...
                    <tr data-id="${v.wallId}">
                        <td class="td-vm">
                            <label class="id_checkbox img_checkbox_label in-td-line">
                                <i class="icon_checkbox"></i>
                                <input type="checkbox" class="img_checkbox row-checkbox" value="${v.wallId}">
                            </label>
                        </td>
                        <td class="td-vm">${v.wallOrder}</td>
                        <td class="td-vm">${v.wallTitle}</td>
                        <td class="td-vm"><img src="${v.wallImg}"></td>
                        <td class="td-vm">${v.wallUrl}</td>
                        <td class="td-vm">
                            <c:if test="${v.wallStatus == '0'}">IOS开启</c:if>
                            <c:if test="${v.wallStatus == '1'}">Andriod开启</c:if>
                            <c:if test="${v.wallStatus == '2'}">全部开启</c:if>
                            <c:if test="${v.wallStatus == '3'}">全部关闭</c:if>
                        </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="add_desc" id="add_desc-label">
                                    描述
                                </label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-6">
                                <label for="edit_desc" id="edit_desc-label">
                                    描述
                                </label>
