...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    ...
    <tiles:putAttribute name="scriptArea">
        <script src="/client/js/page/banner.js" type="text/javascript"></script>
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-edit-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/banner/edit"
                                role="button">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-delete-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/banner/remove"
                                role="button">
