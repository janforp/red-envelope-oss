...
<tiles:insertTemplate template="/WEB-INF/views/base/layout/layout-default.jsp">
    ...
    <tiles:putAttribute name="scriptArea">
        <script src="/client/js/page/index_sort.js" type="text/javascript"></script>
        ...
        <div class="main-bd">
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-edit-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/indexSort/edit"
                                role="button">
                        ...
                        <button class="btn btn-default btn-sm navbar-btn row-delete-btn"
                                ...
                                data-url="${BASE_PATH}/c/page/console/auth/indexSort/remove"
                                role="button">
            ...
            <table class="table table-striped table-hover table-bordered table-row-check">
                ...
                <tr>
                    ...
                    <th class="w50"><spring:message code="oss.indexSort.order"/></th>
                    <th class="w100"><spring:message code="oss.indexSort.name"/></th>
                    <th class="w100">图片</th>
                    <th class="w50"><spring:message code="oss.indexSort.status"/></th>
                    <th class="w100"><spring:message code="oss.indexSort.desc"/></th>
                    <th class="w100">最低显示版本</th>
                    <th class="w100">最低显示版本的渠道</th>
                    <th class="w100">最低显示版本的包名</th>
                    <th class="w100">当前审核版本</th>
                    <th class="w100">审核通过的渠道-包名</th>
                </tr>
                </thead>
                <tbody>
                    ...
                    <tr data-id="${v.sortId}">
                        <td class="td-vm">
                            <label class="id_checkbox img_checkbox_label in-td-line">
                                <i class="icon_checkbox"></i>
                                <input type="checkbox" class="img_checkbox row-checkbox" value="${v.sortId}">
                            </label>
                        </td>
                        <td class="td-vm">${v.sortOrder}</td>
                        <td class="td-vm">${v.sortName}</td>
                        <td class="td-vm"><img src="${v.sortImg}"></td>
                        <td class="td-vm">
                            <c:if test="${v.sortStatus == '0'}">IOS开启</c:if>
                            <c:if test="${v.sortStatus == '1'}">Andriod开启</c:if>
                            <c:if test="${v.sortStatus == '2'}">全部开启</c:if>
                            <c:if test="${v.sortStatus == '3'}">全部关闭</c:if>
                        </td>
                        <td class="td-vm">${v.sortDesc}</td>
                        ...
                        <td class="td-vm">${v.verifyVersion}</td>
                        <td class="td-vm">
                            <c:choose>
                                <c:when test="${v.verifyChannelPackage == '-1'}">
                                    全部未通过
                                </c:when>
                                <c:when test="${v.verifyChannelPackage == '0'}">
                                    全部通过
                                </c:when>
                                <c:otherwise>
                                    ${v.verifyChannelPackage}
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
                ...
                <tfoot>
                <tr>
                    <td colspan="11"><bs:pagination url="${REQUEST_URI}" page="${pg}"/></td>
                </tr>
                </tfoot>
            </table>
        </div>
    ...
    <tiles:putAttribute name="modalArea">
        <!-- 添加 end -->
        <div id="modal-add-sort" aria-labelledby="modal-add-sort-title" class="modal fade" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><spring:message code="oss.title.indexSort.add"/></h4>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="add_title" id="add_title-label">
                                    <spring:message code="oss.banner.title"/>
                                </label>
                            ...
                            <div class="form-group col-xs-6">
                                <label for="add_status" id="add_status-label">
                                    <spring:message code="oss.banner.status"/>
                                </label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="add_order" id="add_order-label">
                                    <spring:message code="oss.indexSort.order"/>
                                </label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">
                                    <spring:message code="oss.indexSort.desc"/>
                                </label>
                                <div class="col-sm-8">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="add_desc" value="1"> 兑换码红包
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="add_desc" value="2"> 微信现金红包
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="add_desc" value="3"> 任务
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="add_verify_version" id="add_verify_version-label">
                                    当前审核版本
                                </label>
                                <input type="text" class="form-control" id="add_verify_version"
                                       name="add_verify_version">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="add_verify_channel_package_name" id="add_verify_channel_package_name-label">
                                    审核通过的渠道-包名
                                </label>
                                <select id="add_verify_channel_package_name" name="add_verify_channel_package_name"
                                        class="selectpicker show-tick form-control" multiple data-live-search="false">
                                    <option value="-1">全部未通过</option>
                                    <option value="0">全部通过</option>
                                    <c:forEach items="${packageChannels}" var="v">
                                        <option value="${v.channelName}-${v.packageName}">
                                                ${v.channelName} - ${v.packageName}
                                        </option>
                                    </c:forEach>
                                </select>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success add_submit_btn" id="add_sort">
        ...
        <div id="modal-edit-sort" aria-labelledby="modal-edit-sort-title" class="modal fade" tabindex="-1"
             role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="edit_title" id="edit_title-label">
                                    <spring:message code="oss.indexSort.name"/>
                                </label>
                            ...
                            <div class="form-group col-xs-6">
                                <label for="edit_status" id="edit_status-label">
                                    <spring:message code="oss.indexSort.status"/>
                                </label>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="edit_order" id="edit_order-label">
                                    <spring:message code="oss.banner.order"/>
                                </label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="edit_desc" value="1"> 兑换码红包
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="edit_desc" value="2"> 微信现金红包
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" name="edit_desc" value="3"> 任务
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="edit_verify_version" id="edit_verify_version-label">
                                    当前审核版本
                                </label>
                                <input type="text" class="form-control" id="edit_verify_version"
                                       name="edit_verify_version">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="edit_verify_channel_package_name" id="edit_verify_channel_package_name-label">
                                    审核通过的渠道-包名
                                </label>
                                <select id="edit_verify_channel_package_name" name="edit_verify_channel_package_name"
                                        class="selectpicker show-tick form-control" multiple data-live-search="false">
                                    <option value="-1">全部未通过</option>
                                    <option value="0">全部通过</option>
                                    <c:forEach items="${packageChannels}" var="v">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default auto-focus-btn" data-dismiss="modal">
                            <spring:message code="btn.cancel"/></button>
                        <button type="button" class="btn btn-success add_submit_btn" id="edit_sort">
                            <spring:message code="btn.save"/></button>
                    </div>
                </div>
            </div>
                ...
                <%--<div class="modal-content">--%>
                    <%--<div class="modal-header">--%>
                        <%--<button type="button" class="close" data-dismiss="modal" aria-label="Close">--%>
                            <%--<span aria-hidden="true">&times;</span>--%>
                        <%--</button>--%>
                        <%--<h4 class="modal-title"><spring:message code="oss.title.indexSort.edit"/></h4>--%>
                    <%--</div>--%>
                    <%--<input type="hidden" id="edit_id" name="edit_id">--%>
                    <%--<div class="modal-body">--%>
