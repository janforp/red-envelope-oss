            ...
            <div class="collapse navbar-collapse">
                <span>
                    ...
                    <select style="width: 170px;height: 25px;" id="showOrNot">
                        <option value="1" <c:if test="${mission.showOrNot == '1'}">selected</c:if>  >显示</option>
                        <option value="0" <c:if test="${mission.showOrNot == '0'}">selected</c:if>  >不显示</option>
                    </select>
                </span>
            </div>
            <br>
                ...
                <span>
                    ...
                    <span>
                        <div  style="height: 700px;width: 900px;">
                            <script id="content" name="content">${mission.missionRule}</script>
                        </div>
                    </span>
                </span>
            </div>
