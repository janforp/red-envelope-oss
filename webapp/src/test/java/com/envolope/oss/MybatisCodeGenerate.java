 ...
 * @Author : wuqiang
 */
public class MybatisCodeGenerate extends BaseTest {
    // -custom
    private static String[] tableNames = new String[]{"re_recommend_mission"};
    // 程序会自动找到basePath
    ...
    @Autowired
    private DruidDataSource jdbcDataSource;
    ...
    public void codegenForOneTable(String oneTableName) throws Exception {
        ...
        String sqlmapBasePath = "src/main/resources/mybatis/mappers/";
        String schema = "red_envelope";
        String fileCharset = "utf-8";
        String modalPackage = "com.envolope.oss.model";
        String daoPackage = "com.envolope.oss.dao";
...
//        System.out.println(buf);
    ...
    private String buildDaoInterface(TableInfo tableInfo, String daoPackage, String modalPackage) {
...
//        System.out.println(buf);
    ...
    private String buildDao(TableInfo tableInfo, String daoImplPackage,
                            String modalPackage) {
        StringBuilder buf = new StringBuilder(1024);
        String tableName = tableInfo.getTableName();
        String daoImplName = getDaoNameByTableName(tableName);
        String modalName = getMobalNameByTableName(tableInfo.getTableName());
        String modalNameWithPackage = modalPackage + "." + modalName;
        String newLine = "\n";
...
//        System.out.println(buf);
    ...
    private String buildCustomSqlMapper(TableInfo tableInfo, String modalPackage) {
        ...
        buf.append(
                ...
                .append(newLine);
        buf.append(
                "<mapper namespace=\"").append(tableName).append("\">")
                .append(newLine);
        buf.append("</mapper>");
        return buf.toString();
    }
...
//        System.out.println(buf);
    ...
    private String getJavaTypeByJdbcType(String jdbcType) {
        if (jdbcType.equalsIgnoreCase("int") || jdbcType.equalsIgnoreCase("integer") || jdbcType
            ...
            return "Long";
        } else if (jdbcType.equalsIgnoreCase("varchar") || jdbcType.equalsIgnoreCase("text") || jdbcType.equalsIgnoreCase("CHAR")) {
            return "String";
